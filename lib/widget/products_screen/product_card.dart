...
import 'package:mv_vendor_app/modules/product_details_screen/product_details_screen.dart';
                          ...
                          SlidableAction(
                            onPressed: (context) {
                              service.products.doc(id).update({
                                'approved':
                                    product.approved == false ? true : false
                              });
                            },
                            flex: 1,
